(ns marketentry.store
  "SSoT for the HRV market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems HRV" :portal "EOJN RH (Elektronički oglasnik javne nabave)"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 12
             :claimed-fee 700000.0
             :requires-foreign-investment-approval? true :foreign-investment-approval-verified? true
             :drafted? false :submitted? false
             :jurisdiction "HRV" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "EOJN RH (Elektronički oglasnik javne nabave)"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 12
             :claimed-fee 700000.0
             :requires-foreign-investment-approval? true :foreign-investment-approval-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ATL" :status :intake}
    "eng-3" {:id "eng-3" :operator "Minami Trading Zagreb" :portal "EOJN RH (Elektronički oglasnik javne nabave)"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 12
             :claimed-fee 999000.0
             :requires-foreign-investment-approval? true :foreign-investment-approval-verified? true
             :drafted? false :submitted? false
             :jurisdiction "HRV" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "EOJN RH (Elektronički oglasnik javne nabave)"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 12
             :claimed-fee 700000.0
             :requires-foreign-investment-approval? true :foreign-investment-approval-verified? false
             :drafted? false :submitted? false
             :jurisdiction "HRV" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-foreign-investment-approval? foreign-investment-approval-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-foreign-investment-approval?)     (assoc :engagement/requires-foreign-investment-approval? requires-foreign-investment-approval?)
    (some? foreign-investment-approval-verified?)     (assoc :engagement/foreign-investment-approval-verified? foreign-investment-approval-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-foreign-investment-approval? :engagement/foreign-investment-approval-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-foreign-investment-approval? (boolean (:engagement/requires-foreign-investment-approval? m))
     :foreign-investment-approval-verified? (boolean (:engagement/foreign-investment-approval-verified? m))
