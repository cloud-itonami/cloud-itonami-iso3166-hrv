(ns marketentry.registry
  ...
  call to any real procurement portal (EOJN RH). It builds the RECORD
  an operator would keep, not the act of submitting a portal
...
(defn register-draft
  ...
  market-entry operator's own act of preparing an EOJN RH registration
...
(defn register-submit
  ...
  market-entry operator's own act of actually submitting a real EOJN
  RH registration (always human-gated upstream)."
  [engagement-id jurisdiction sequence]
  (when-not (and engagement-id (not= engagement-id ""))
