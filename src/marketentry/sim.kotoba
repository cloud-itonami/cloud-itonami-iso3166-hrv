...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (HRV, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up foreign-investment-approval-missing) ==")
    ...
    (println "== filing/submit eng-4 (foreign-investment-approval-missing -> HARD hold) ==")
